...
const areEquals = (
  ...
  const prevDomInnerHTML = prevProps.element.innerHTML;
  const nextDomInnerHTML = nextProps.element.innerHTML;
  // Don't re-render when HTML is still the same
  return prevDomInnerHTML === nextDomInnerHTML;
};
